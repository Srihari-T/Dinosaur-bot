...
def imageGrab():  
    ...
    box = (cordinates.dinasaur[0]+80, cordinates.dinasaur[1]+20, 
           cordinates.dinasaur[0]+120, cordinates.dinasaur[1]+70) 
...
while True:  
     ...
     if(imageGrab()!=6254):    
        press_space()    
        #time to recogni ze the operation performed by above function  
        time.sleep(0.05)
